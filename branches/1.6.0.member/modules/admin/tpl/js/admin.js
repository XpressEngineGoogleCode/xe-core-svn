...
jQuery(function($){
    ...
    .next()
    .focus(function(){
        var $label = $(this).prev().stop().animate({
            opacity:0,
            left:'25px'
        },'fast',function(){
    ...
    .blur(function(){
        var $this = $(this), $label;
        if($.trim($this.val()) == '') {
            $label = $this.prev().stop().css('visibility','visible').animate({
                opacity:1,
                left:'5px'
            },'fast');
        }
    ...
    .focusout(function(){
        ...
        timer = setTimeout(function(){
            if(!$this.find(':focus').length) $this.mouseleave()
        }, 10);
    ...
    $.fn.xeMask = function(){
        ...
        .each(function(){
            ...
            if(reg_mail.test(text)) {
                ...
                .hover(
                    function(){
                        $(this).next('.cover').mouseover()
                    },
                    function(){
                        $(this).next('.cover').mouseout()
                    }
                    )
                .end()
                .find('>.cover')
                ...
                .hover(
                    function(){
                        $(this).css('opacity',1).prev('span').css('visibility','hidden')
                    },
                    function(){
                        $(this).css('opacity',0).prev('span').css('visibility','visible')
                    }
                    )
                .end();
            }
        ...
        .click(function(){
            ...
            if(!$modal.parent('body').length) {
                ...
                $btnClose.click(function(){
                    $modal.data('anchor').trigger('close.mw')
                });
...
jQuery(function($){
    ...
    $.fn.xeModuleFinder = function(caller){
        ...
        .bind('before-open.tc', function(){
            ...
            $.exec_json('admin.getSiteAllList', {
                domain:val
            }, on_complete);
        })
        .end()
        ...
        .delegate('button','click',function(){
            ...
            $.exec_json('module.procModuleAdminGetList', {
...
jQuery(function($){
    ...
    $.fn.xeSortableTable = function(){
        ...
        .delegate('.dragBtn', 'mousedown.st', function(event){
            ...
            $th.filter('[colspan]').attr('colspan', function(idx,attr){
                cols += attr - 1;
            });
        ...
        .click(function(){
            ...
            function save_lang() {
                ...
                $input.each(function(k,v){
                    var $this = $(this);
                    params[$this.parent('li').attr('class')] = $this.val()
                });
    ...
    .bind('before-open.mw', function(){
        ...
        function on_complete(data){
            ...
            .bind('click', function(){
                ...
                $.exec_json('module.getFileBoxListHtml', {
                    'page': page
                }, on_complete);
