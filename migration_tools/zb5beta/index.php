        ...
        if($target_module == 'module' && !$module_id) {
            ...
            switch($target_module) {
                ...
                case 'message' :
                    ...
                    break;
                case 'module' :
                        $query = sprintf("select count(*) as count from %sarticles where module_srl = '%d'", $db_info->db_prefix, $module_id);
                    break;
            }
...
<head>
    ...
    <title>zb5beta data export tool ver 0.2</title>
    <style type="text/css">
...
<body>
    ...
    <h1>zb5beta data export tool ver 0.2</h1>
    ...
    <input type="hidden" name="path" value="<?php echo $path?>" />
        ...
        <blockquote>zb5beta는 회원정보와 그외 모듈 종류를 나누어 추출하실 수 있습니다.</blockquote>
