<?php 
    ...
    // 게시판 목록 구하기
    $query = "select * from {$db_info->db_table_prefix}_modules where module in ('board','guestbook','blog')";
...
?>
    ...
    <input type="hidden" name="path" value="<?php echo $path?>" />
        ...
        <div class="desc">zbxe는 회원정보와 그외 모듈 종류를 나누어 백업하실 수 있습니다.</div>
    ...
    ?>
                    <option value="<?php echo $module_info->module_srl?>"><?php echo $module_info->browser_title?></option>
    <?php
        }
    ?>
                </select>
