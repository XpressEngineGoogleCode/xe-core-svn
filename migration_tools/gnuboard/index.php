<?php 
    ...
    if($step == 2) {
        ...
        while($module_info = $oMigration->fetch($module_list_result)) {
            $module_list[$module_info->bo_table] = $module_info;
        }
...
<head>
    ...
    <title>gnuboard4 data export tool ver 0.2</title>
    <style type="text/css">
...
<body>
    ...
    <h1>gnuboard4 data export tool ver 0.2</h1>
    ...
    <form action="./index.php" method="post">
        ...
        <ul>
            <li>
                gnuboard4 가 설치된 경로를 입력해주세요.

                <blockquote>
                    예1) /home/아이디/public_html/gnuboard4<br />
                    예2) ../gnuboard4<br />
                </blockquote>
    ...
    <input type="hidden" name="db_type" value="<?php echo $db_type?>" />
        ...
        <blockquote>gnuboard4는 회원정보와 그외 모듈 종류를 나누어 추출하실 수 있습니다.</blockquote>
    ...
    <input type="hidden" name="db_type" value="<?php echo $db_type?>" />
        ...
        <blockquote>
            ...
            다운을 받지 않고 URL을 직접 gnuboard4 데이터이전 모듈에 입력하여 데이터 이전하실 수도 있습니다.
        </blockquote>
