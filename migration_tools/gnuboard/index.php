<?php 
    /**
     * @brief gnuboard4 마이그레이션 index 파일
     * gnuboard4 의 마이그레이션은 경로와 charset을 입력받고 회원 또는 게시판 ID를 선택받아 xml 파일을 출력하는 순서로 동작
     **/
...
?>
    ...
    <form action="./module_list.php" method="post">
        <div class="title">Step 1. gnuboard4 경로 입력</div>
        <div class="desc">
            gnuboard4가 설치된 경로를 입력해주세요.<br />
            <br />
