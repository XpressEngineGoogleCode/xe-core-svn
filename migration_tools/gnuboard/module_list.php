...
?>
    ...
    <input type="hidden" name="charset" value="<?php echo $charset?>" />
        ...
        <div class="desc">gnuboard4는 회원정보와 그외 게시판으로 종류를 나누어 백업하실 수 있습니다.</div>
    ...
    <?php
		...
		$bo_table = trim($module_info->bo_table);
		$bo_subject = convStr(trim($module_info->bo_subject), $charset);
    ?>
                    <option value="<?php echo $bo_table?>"><?php echo $bo_subject?></option>
    <?php
        }
    ?>
                </select>
