...
typeof g.length||1>g.length)g=Array(g);if(g.length)for(var k=0;k<g.length;k++){var j=g[k].url,m=g[k].str,n=g[k].target,h="";switch(n){case "popup":h=" onclick=\"popopen(this.href,'"+n+"'); return false;\"";break;case "javascript":h=' onclick="'+j+'; return false; "',j="#"}b+='<li ><a href="'+j+'"'+h+">"+m+"</a></li> "}}this.loaded_popup_menus[c]=b}b&&(c=a("#popup_menu_area").html("<ul>"+b+"</ul>"),b=e.page_y,e=e.page_x,c.outerHeight()+b>a(window).height()+a(window).scrollTop()&&(b=a(window).height()-
c.outerHeight()+a(window).scrollTop()),c.outerWidth()+e>a(window).width()+a(window).scrollLeft()&&(e=a(window).width()-c.outerWidth()+a(window).scrollLeft()),c.css({top:b,left:e}).show().focus())}}})(jQuery);
jQuery(function(a){a('a[href^="#"]').click(function(){a(a(this).attr("href")).attr("tabindex","0").focus()});a.browser.msie&&a("select").each(function(a,b){for(var g=!1,d=[],j=0;j<b.options.length;j++)b.options[j].disabled?(b.options[j].style.color="#CCCCCC",g=!0):d[a]=-1<d[a]?d[a]:j;if(g&&(b.oldonchange=b.onchange,b.onchange=function(){this.options[this.selectedIndex].disabled?this.selectedIndex=d[a]:this.oldonchange&&this.oldonchange()},0<=b.selectedIndex&&b.options[b.selectedIndex].disabled))b.onchange()});
...
"")},1E3)),u.html(waiting_message).show())}};a.exec_json=function(b,c,e,g){"undefined"==typeof c&&(c={});b=b.split(".");if(2==b.length){var k=a(".wfsr").data("timeout_id");k&&clearTimeout(k);a(".wfsr").css("opacity",0);a(".wfsr").data("timeout_id",setTimeout(function(){a(".wfsr").css("opacity","")},1E3));show_waiting_message&&a(".wfsr").html(waiting_message).show();a.extend(c,{module:b[0],act:b[1]});"undefined"!=typeof xeVid&&a.extend(c,{vid:xeVid});a.ajax({type:"POST",dataType:"json",url:request_uri,
contentType:"application/json",data:a.param(c),success:function(b){a(".wfsr").hide().trigger("cancel_confirm");0!=b.error&&-1E3<b.error?(-1==b.error&&"msg_is_not_administrator"==b.message?alert("You are not logged in as an administrator"):alert(b.message),a.isFunction(g)&&g(b)):a.isFunction(e)&&e(b)}})}};a.fn.exec_html=function(b,c,e,g,k){"undefined"==typeof c&&(c={});a.inArray(e,["html","append","prepend"])||(e="html");var j=a(this);b=b.split(".");if(2==b.length){var m=a(".wfsr").data("timeout_id");
m&&clearTimeout(m);a(".wfsr").css("opacity",0);a(".wfsr").data("timeout_id",setTimeout(function(){a(".wfsr").css("opacity","")},1E3));show_waiting_message&&a(".wfsr").html(waiting_message).show();a.extend(c,{module:b[0],act:b[1]});a.ajax({type:"POST",dataType:"html",url:request_uri,data:a.param(c),success:function(b){a(".wfsr").hide().trigger("cancel_confirm");j[e](b);a.isFunction(g)&&g(k)}})}};a(function(a){a(".wfsr").ajaxStart(function(){a(window).bind("beforeunload",b)}).bind("ajaxStop cancel_confirm",
